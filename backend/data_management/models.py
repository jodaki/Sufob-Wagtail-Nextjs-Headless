...
class AllData(models.Model):
    """تمام داده‌های خام استخراج شده از API سازمان بورس"""
    ...
    # قیمت‌ها
    weighted_final_price = models.DecimalField(
        max_digits=15, decimal_places=2, null=True, blank=True,
        verbose_name="قیمت پایانی موزون"
    )
    final_price = models.DecimalField(
        max_digits=15, decimal_places=2, null=True, blank=True,
        verbose_name="قیمت پایانی"
    )
    ...
    first_price = models.DecimalField(
        max_digits=15, decimal_places=2, null=True, blank=True,
        verbose_name="قیمت اولین معامله"
    )
    ...
    class Meta:
        ...
        unique_together = ['isin', 'trade_date']  # یک رکورد برای هر نماد در هر روز
